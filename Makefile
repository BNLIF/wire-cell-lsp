...
householder_transform.test: householder_transform.cpp ./include/lsp/householder_transform.h singular_decomposition.h
	$(CXX) $(CXXFLAGS)  -o householder_transform.test -DTEST householder_transform.cpp

singular_decomposition.test: singular_decomposition.cpp singular_decomposition.h ./include/lsp/householder_transform.h qr_decomposition.h
	$(CXX) $(CXXFLAGS)  -o singular_decomposition.test -DTEST singular_decomposition.cpp

qr_decomposition.test: qr_decomposition.cpp qr_decomposition.h ./include/lsp/givens_rotation.h
